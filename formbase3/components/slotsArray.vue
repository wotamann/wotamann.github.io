<style>
  #formslotarray { background-color: #fafafa; border:1px solid #ddd;  }
  #formslotarray .slot{ font-size: 0.9rem; font-weight:400 ; width:100%; padding:6px; margin:2px  }
  #formslotarray .form{ padding:8px;  color: #047a35; background-color: #49f28f3c;border: 1px solid #88e3ae; }
  #formslotarray .outside { background-color: #9cc7ff25; border: 1px solid #376de8;}
  #formslotarray .outsidearr { background-color: #b4d4fdc9; border: 1px solid #1641a6; }
  #formslotarray .outsidekey { background-color: #71a3e4c9; border: 1px solid #1641a6; }
  #formslotarray .inside { background-color: #ffd5db25; border: 1px solid #f55066; }
  #formslotarray .insidearr { background-color: #febac3; border: 1px solid #ca3e51;}
  #formslotarray .insidekey { background-color: #e47b89; border: 1px solid #ca3e51; }
</style>
<template>
  <v-container fluid>
    ...
    >
        ...
        <template #slot-inject-label-key-formslotarray-tasks-1-out="{obj, idx, id, index, item}">
          <span class="outsidearr">INJECTED LABEL</span>
        </template>
        <template #slot-inject-label-key-formslotarray-tasks-0-tasksIn-1-in="{obj, idx, id, index, item}">
