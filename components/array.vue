        ...
        schema: {
          ...
          add: { el: 'btn', cols:2, iconL: 'mdi-plus', text:'Add IN-Task', color: 'blue lighten-4',
            onClick:(ev, obj, ec) => {
              ...
              // myModel.value.tasks[ec.indexOfArrays[0]].task.splice(ec.indexOfArrays[1],0,getTask())
              // ec.globalModel.tasks[ec.indexOfArrays[0]].task.push(getTask())   
              ec.globalModel.tasks[ec.indexOfArrays[0]].task.splice(ec.indexOfArrays[1],0,getTask())
            }
          },
          delete: { el: 'btn', cols:2, iconL: 'mdi-plus', text:'Delete IN-Task', color: 'red lighten-4',
            onClick:(ev, obj, ec) => {
              
              console.log('# CLICKEVENT OBJ ', ec.indexOfArrays[0], ec.indexOfArrays[1], obj ) 
              console.log('# CLICKEVENT IN', ec.globalModel.value ) 
              
              // myModel.value.tasks[ec.indexOfArrays[0]].task.splice(ec.indexOfArrays[1],1)
              ec.globalModel.tasks[ec.indexOfArrays[0]].task.splice(ec.indexOfArrays[1],1)
            //  return '1234567890'
            }
          }
        }
